export default function ExperienceSection() {
  ...
  return (
    <section id="experiences" className="relative px-4 py-16 bg-black scroll-mt-24">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid items-center gap-12 pt-8 lg:grid-cols-2">
          ...
          <div className="space-y-4 order-2 lg:order-1">
            {experiences.map((exp, index) => (
              <div key={index} className="w-full">
                <div className={`relative rounded-xl bg-gradient-to-r ${gradients[index]} p-[2px]`}>
                  <div className="rounded-xl bg-slate-800/90 p-6 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:transform hover:shadow-2xl hover:shadow-purple-500/10">
          ...
          {/* Right side - 3D Laptop Illustration */}
                ...
                <div className="rounded-lg bg-gradient-to-br from-purple-600 to-pink-600 p-1 shadow-2xl">
                  <div className="h-52 w-80 rounded-md bg-slate-900 p-6">
                    ...
                    <div className="space-y-2 font-mono text-sm">
                      <div className="text-pink-400">{'<div className="app">'}</div>
